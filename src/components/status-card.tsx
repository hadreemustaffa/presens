...
import { FULL_DAY_WORK_HOURS, LUNCH_HOURS, TZ_KUALA_LUMPUR } from '@/lib/constants';
...
export default function StatusCard(record: AttendanceRecord) {
  ...
  const expectedEnd = convertUtcToLocalTime(record.clock_in, TZ_KUALA_LUMPUR).add(
    FULL_DAY_WORK_HOURS + LUNCH_HOURS,
    'hours',
  );
